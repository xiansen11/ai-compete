...
class IntentTreeAutoInitializerTests {

    @Test
    void runCallsIdempotentFactoryInitializer() {
        IntentTreeService intentTreeService = mock(IntentTreeService.class);
        IntentTreeAutoInitializer initializer = new IntentTreeAutoInitializer(intentTreeService);
